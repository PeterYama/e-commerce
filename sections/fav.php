...
if(isset($_POST['favSession'])){
	...
	<div class="row d-flex justify-content-center" id="result">
		...
		';
    foreach ($_POST['favSession'] as $item) {
        ...
        <div class="col">
            ...
            <small>' . $row['P_Description'] . '</small>
                ...
                <div class="d-flex align-items-end flex-column">
                    <button type="button" class="btn btn-primary btn-link btn-xs mt-4 right" id="fav-delete-btn" value="' . $row['P_ID'] . '">
...
echo '
	<div class="container d-flex justify-content-center text-center mt-5" >
		<div class="row" id="fav-empty-message" style="display:none;">
			<div class="col mt-5">
					<h1>Wishlist is empty<br></h1>
					<h2 class="mt-5">Try adding something :)<br></h2>
